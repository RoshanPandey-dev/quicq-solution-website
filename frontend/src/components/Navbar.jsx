...
export default function Navbar() {
  ...
  const openMenu = useCallback(() => {
    ...
    iconTl
      .to(line2Ref.current, { scaleX: 0, duration: 0.15, ease: "power2.in" })
      .to(
        line1Ref.current,
        {
          y: 6,
      ...
      >
        <div className="container navbar-inner">
          ...
          <div className="navbar-actions">
            <a href="tel:+123889866666" className="navbar-phone" id="nav-phone">
              <Phone size={18} />
              <span>+123 889866666</span>
            </a>
            <Link
              to="/contact"
        ...
        <div className="mobile-menu-content">
          <ul className="mobile-menu-links">
              ...
              <li key={item.to}>
                ...
                <div className="mobile-menu-link-item" ref={setLinkRef(i)}>
                  ...
                  {item.to.startsWith("/#") ? (
                    <a
                      href={item.to}
                      className={`mobile-menu-label ${location.pathname === "/" ? "active" : ""}`}
                      onClick={closeMenu}
                    >
                      {item.label}
                    ...
                    <Link
                      to={item.to}
                      className={`mobile-menu-label ${location.pathname === item.to ? "active" : ""}`}
                      onClick={closeMenu}
                    >
                      {item.label}
                      <ArrowRight className="mobile-menu-arrow" size={24} />
            ...
            <div
              ...
              ref={setLineRef(NAV_ITEMS.length)}
            />
          </ul>

          <div className="mobile-menu-footer" ref={footerRef}>
            <a href="tel:+123889866666" className="mobile-menu-phone">
              <Phone size={18} />
              <span>+123 889866666</span>
            </a>
            <Link
